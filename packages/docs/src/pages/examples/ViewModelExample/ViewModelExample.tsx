...
import { ExampleBlock } from '@pages/examples/ExampleBlock';
...
export const ViewModelExample = () => (
  <Box sx={{ mt: 3 }}>
    ...
    >
      ...
      component (<Code>observer</Code>, <Code>view</Code> or <Code>childView</Code>), when the reaction will be calling
